...
CLASSIFICATION_LABELS = {
    ...
    'is_CGM_accreted': 'accreted onto central',
    'is_CGM_ejected': 'ejected into IGM',
    'is_CGM_accreted_to_satellite': 'accreted onto satellite',
    'is_CGM_halo_transfer': 'halo transfer',
    'is_in_main_gal': 'main galaxy',
    'is_in_galaxy_halo_interface': 'galaxy-halo interface',
    'is_in_CGM': 'CGM',
    'is_in_IGM': 'IGM',
    'is_in_other_gal': 'other galaxy',
    'is_in_other_CGM': 'other CGM',
    'is_in_other_gal_outside_CGM': 'external galaxy',
    'is_in_other_CGM_not_main': 'external CGM',
}
...
CLASSIFICATION_COLORS_B = {
    ...
    'is_in_main_gal': palettable.cartocolors.qualitative.Safe_10.mpl_colors[0],
    'is_in_galaxy_halo_interface': palettable.cartocolors.qualitative.Safe_10.mpl_colors[3],
    'is_in_CGM': palettable.cartocolors.qualitative.Safe_10.mpl_colors[2],
    'is_in_IGM': palettable.cartocolors.qualitative.Safe_10.mpl_colors[1],
    ...
    'is_in_other_gal_outside_CGM': palettable.cartocolors.qualitative.Safe_10.mpl_colors[6],
    'is_in_other_CGM_not_main': palettable.cartocolors.qualitative.Safe_10.mpl_colors[7],
}
