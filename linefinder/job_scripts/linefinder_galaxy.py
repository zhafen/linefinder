...
linefinder_args = {
    ...
    'out_dir': '/scratch/03057/zhafen/linefinder_data/core/m12b_res57000/data',

    # Location of simulation data
    'sim_data_dir': '/scratch/projects/xsede/GalaxiesOnFIRE/core/m12b_res57000/output',

    # Location of halo file data
    'halo_data_dir': '/scratch/04613/tg839127/ahf/m12b_res57000/output',
    ...
    'selector_data_filters': {
        ...
        'Radial Cut' : { 'data_key': 'Rf', 'data_min': -1.0, 'data_max': 0.1, },
