...
## DAA: compute stellar age at a given redshift given the scale factor at formation time
def stellar_age(z,aform,h=0.71,Omega_M=0.27):
    zform = 1./aform - 1.
    return 1e3 * ( age_of_universe(z,h=h,Omega_M=Omega_M) - age_of_universe(zform,h=h,Omega_M=Omega_M) );  # in Myr
